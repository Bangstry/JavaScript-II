...
runners.forEach(function(){
    ...
    let runner= item.first_name + " " + item.last_name;
    fullName.push(runner)
});
...
largeShirts = runners.filter(function(item,index,array){
...
ticketPriceTotal = runners.reduce((accum, current ) =>{ 
